...
const plans = [
  {
    ...
    description:
      "This app was built for you. You get access to all of our learning modules, helpful resources, and tools to help you navigate the challenges of adulthood. It's free, and always will be.",
    button: {
  ...
  },
  {
    ...
    description:
      "That little bit extra. In additional to all of the features of the Essential plan, you'll get access to 1-on-1 coaching with a certified financial planner and exclusive networking features.",
    button: {
      label: 'Subscribe',
      href: '/register',
    },
