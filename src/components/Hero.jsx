...
const lessons = [
  { title: "Lesson 1: Budgeting"},
  { title: "Lesson 2: Credit"},
  { title: "Lesson 3: Insurance"},
  { title: "Lesson 4: Taxes"},
  { title: "Lesson 5: Investing"},
]
      ...
      <AppScreen.Body>
        <div className="p-4">
          <div className='flex flex-col gap-2 border-b pb-4'>
            <div className="text-lg">Finance Literacy</div>
            <div className='text-xs text-gray-500'>Learn topics surrounding personal finance</div>
          </div>
          <div className='flex flex-col gap-4 pt-4'>
            {lessons.map((lesson, index) => (
              <div key={index} className='flex items-center justify-center p-4 border border-gray-200 rounded-lg'>
                {lesson.title}  
              </div>
            ))}
          </div>
      ...
      <Container>
        <div className="lg:grid lg:grid-cols-12 lg:gap-x-8 lg:gap-y-20">
          <div className="relative z-10 mx-auto max-w-2xl lg:col-span-7 lg:max-w-none lg:pt-6 xl:col-span-6">
            ...
            Acquire essential life skills and knowledge to overcome the challenges of adulthood and thrive in the real world.
            </p>
